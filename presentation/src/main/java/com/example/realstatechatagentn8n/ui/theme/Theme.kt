package com.example.realstatechatagentn8n.ui.theme
...
import com.example.mygithubusersapplications.ui.theme.AppColor
...
fun AppTheme(
    ...
    systemUiController.setStatusBarColor(color = Color(0xFFF6F6F6))
